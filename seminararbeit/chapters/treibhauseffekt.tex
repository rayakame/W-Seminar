...
Daraus ergibt sich $\varepsilon_{\text{CO}_2} = \SI{23.01}{\percent}$. Nach dieser Berechnung trägt CO\textsubscript{2} mit etwa $\SI{29.6}{\percent}$ zum
...
Wir haben bereits erkannt das die Annahme das die Atmosphäre einen konstanten Teil $\varepsilon$ der
IR-Strahlung absorbiert eine starke Vereinfachung ist. In der Realität weist die Atmosphäre eine 
ausgeprägt spektrale Struktur auf:
\ifthenelse{\boolean{abbildungen}}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{assets/atmosphäre_absorption.pdf}
        \caption{Absorptionsspektrum der Atmosphäre \cite[S.~13]{marshall2007atmosphere}}
...
CO\textsubscript{2} und CH\textsubscript{2} verursacht.

\subsection{Strahlungsantrieb durch CO\texorpdfstring{$_2$}{2}-Erhöhung}
Der Strahlungsantrieb $\Delta F$ wird defindert als die Änderung der Netto-Strahlungsenergieflussdichte
...
Für Änderungen der atmosphärischen CO\textsubscript{2}-Konzentration ergibt sich der Strahlungsantrieb aus detaillierten
...
wobei $C$ die aktuelle CO\textsubscript{2}-Konzentration und $C_0 = 280$ppm die vorindustrielle Referenzkonzentration
...
Mit $T_e = \SI{255}{\kelvin}$ folgt für eine CO\textsubscript{2}-Verdopplung ($\Delta F \approx \SI{3.71}{\watt\per\meter\squared}$) 
eine direkte Temperaturerhöhung von nur etwa $\SI{0.99}{\kelvin}$.

Das reale Klimasystem weist jedoch starke Rückkopplungen auf, hauptsächlich durch Wasserdampf, weswegen im realen Klimasystem eine Verdopplung
von CO\textsubscript{2} zu einer Temperaturerhöhung von $\approx \SI{4}{\kelvin}$ führt \cite{atmosphericCO2}.