...
Die wellenlängenabhängige Absorption von \ce{CO2} $\varepsilon(\lambda)$ wurde mithilfe der HITRAN-Datenbank \cite{DBhitran2020} bestimmt.
...
von \ce{CO2} zu einer Temperaturerhöhung von $\approx \SI{4}{\kelvin}$ führt \cite{atmosphericCO2}.