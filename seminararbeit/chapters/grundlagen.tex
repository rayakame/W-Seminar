...
mit der Temperatur $T$ ein Maximum erreicht, erhält man, indem man die Gleichung \eqref{eq:plancks_law_wavelength} nach 
...
Die spektrale Lage der CO\textsubscript{2}-Absorptionsbanden erklärt, warum CO\textsubscript{2} als Treibhausgas wirkt: Es ist weitgehend transparent für die kurzwellige
Sonnenstrahlung, absorbiert jedoch die langwellige Strahlung, die von der Erde emittiert wird. Die fundamentale Frage, die sich daraus ergibt, ist: \textit{Warum absorbiert 
CO\textsubscript{2} gerade bei diesen Wellenlängen?} Im folgenden Kapitel wird die molekülphysikalische Grundlage dieser Absorption detailliert untersucht.