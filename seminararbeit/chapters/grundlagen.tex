...
\begin{table}[H]
    ...
    \begin{tabularx}{1\textwidth}{l X}
        ...
        \midrule
        Frequenz, $f$ & Anzahl der Schwingungen pro Zeiteinheit, $[\si{\hertz}] = [\si{\second}^{-1}]$ \\
...
\begin{tikzpicture}[scale=0.75]
    ...
    \begin{scope}[xshift=9.5cm]
        ...
        \node[red] at (5.57,-2.3) {$f = 2$ Wellen/s = \SI{2}{\hertz}};
    \end{scope}
\end{tikzpicture}
...
Rechts: Zeitliche Darstellung zeigt die Periode $T$ und die Frequenz $f$.}
