...
Um den Treibhauseffekt zu verstehen, ist es essenziell zu verstehen, wie die Erde den Großteil ihrer Energie erhält und 
wie die Erde ihre überschüssige Energie wieder abgibt. Der Energiehaushalt der Erde wird hauptsächlich durch 
Strahlungsprozesse bestimmt: Die Erde erhält Energie durch Strahlung der Sonne und strahlt selber wieder Energie in
den Weltraum \cite[S.~9--11]{marshall2007atmosphere}. Im folgenden Kapitel betrachten wir diese Strahlungsprozesse im Detail, um die Grundlage
...
aufgefasst werden kann. Keine der beiden Sichtweisen können alle beobachteten Strahlungsphänomene vollständig beschreiben, weshalb beide
...
die Lichtgeschwindigkeit im Vakuum ist und $n$ der Brechungsindex des Mediums ist. 
...
\ifthenelse{\boolean{formeln}}{
  \begin{align*}
  E_{\nu} &\equiv \text{abgestrahlte Energie pro Zeit, Oberfläche und Frequenz.} \\
...
Für einen idealen schwarzen Körper setzen wir $E_{b\nu}$ aus Gleichung 
\eqref{eq:plancks_law_frequenzy} in das Integral ein:
\ifthenelse{\boolean{formeln}}{
  \begin{equation*}
...
\label{sec:wien}
Die Wellenlänge $\lambda_{max}$, bei welcher die spektrale spezifische Ausstrahlung eines idealen schwarzen Körpers $E_{b\lambda}$ 
...
Absorption durch Treibhausgase wie CO\textsubscript{2} ist, wie man schon in \autoref{fig:planck_earth_sun} erkennen kann.
