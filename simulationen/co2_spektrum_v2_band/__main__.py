...
ax1.plot(wn_grid, absorbance_percent, color='darkblue', linewidth=LINEWIDTH,
         label=r"$\mathrm{CO_2}$")
ax1.fill_between(wn_grid, 0, absorbance_percent, color='darkblue', alpha=0.2)

ax1.axvline(V2_CENTER, color='red', linestyle='--', linewidth=LINEWIDTH_BIG,
            label=r'$\nu_2$-Bandzentrum')
...
ax2.plot(wn_grid[q_mask], absorbance_percent[q_mask],
         color='darkblue', linewidth=LINEWIDTH,
         label=r"$\mathrm{CO_2}$")
...
ax2.axvline(V2_CENTER, color='red', linestyle='--', linewidth=LINEWIDTH_BIG,
            label=r'$\nu_2$-Bandzentrum')
